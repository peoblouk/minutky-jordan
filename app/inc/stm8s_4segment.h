...
typedef struct
{
  ...
  void (*num)(uint32_t, uint8_t);
  void (*let)(uint32_t, uint8_t);
  void (*dgt)(bool, uint8_t);
  void (*min)(uint32_t, uint8_t);
  void (*sec)(uint32_t, uint8_t);
} Segment_module;
/**
 * @}
 */
...
void display_num(uint32_t display, uint8_t number_lenght);
void display_let(uint32_t letter, uint8_t dgt);
void display_dgt(bool value, uint8_t dgt);
void display_min(uint32_t display, uint8_t number_lenght);
void display_sec(uint32_t display, uint8_t number_lenght);
